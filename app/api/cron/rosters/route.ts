...
// Triggered by Vercel Cron (see vercel.json). Protected by CRON_SECRET, same as
// the ticket refresh. Pulls each team's current squad from Wikipedia into the
// Player table; manual overrides in data/rosters.json are merged at read time.
